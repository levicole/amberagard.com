...
//**********************************************************************************************
	...
	if(params.Link==true){
		$(node).children('div').each(function(index) {
			var Link = index+1;	
			$(this).append('<a href="#'+params.AscensorName+Link+'" rel="section" class="'+params.AscensorName+'Link'+index+'">liens'+index+'</a>');
			

			resultatLink+='&lt;a href="#'+params.AscensorName+Link+'" rel="section" class="'+params.AscensorName+'Link'+index+'"&gt;liens'+index+'&lt;/a&gt;</br>';
		})
	}	
